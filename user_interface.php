    ...
    <div id="container">
        <div id="panel">
            <div id="title_webpage">PKP Rozkład bassu</div>
                ...
                <?php
                echo "Proszę przygotować głośniki do rozpierdolu.";
                //
                ?>
                ...
                while($wiersz = mysqli_fetch_array($b)) {
                    ...
                    echo "' target='_blank'><abbr title='Przejdź na stronę...'>";
            ...
            <div id="footer">©2023 Strona stworzona przez <a href="https://www.youtube.com/@Ariqu" target="_blank" style="color: white; background: black;"><abbr title="Sprawdź twórczość Ariqu..."><u>Ariqu</u></a> & <a href="https://www.youtube.com/@CaramelBass" target="_blank" style="color: white; background: black;"><abbr title="Sprawdź twórczość Caramel Bass..."><u>Caramel Bass</u>.</a>
            </div>
        </div>
    </div>
</body>
